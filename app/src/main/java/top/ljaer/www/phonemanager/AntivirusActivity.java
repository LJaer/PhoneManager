...
public class AntivirusActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rotateAnimation.setRepeatCount(Animation.INFINITE);//设置旋转次数,INFINITE:一直旋转
                ...
                for (final PackageInfo packageInfo :
                    ...
                    runOnUiThread(new Runnable() {//封装了handler
                        ...
                        public void run() {
                            ...
                            Signature[] signatures = packageInfo.signatures;//获取应用程序的的签名信息,获取签名数组
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if(list.size()>0){
                            ...
                            //卸载病毒
                            final AlertDialog.Builder builder = new AlertDialog.Builder(AntivirusActivity.this);
                        ...
                        iv_antivirus_scanner.clearAnimation();//移除动画
                    }
                });
